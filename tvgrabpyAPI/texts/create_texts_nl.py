    ...
    texts = {
        u'config':{
            u'error':{
                ...
                6: u'Controleer of je tevrede bent met de instellingen.\n',
                7: u'Wanneer dit een nieuwe installatie is, dan moet je eerst de gewenste zenders activeren!\n',
            ...
            u'confighelp':{
                ...
                7: u'# Je kunt altijd je log bestand controleren voor de fijtelijk gebruikte\n',
                8: u'# waarden. Alleen hier getoonde opties kun je hier instellen.\n',
                9: u'',
                10: u'',
                11: u'# Zet always_use_json op False om door het .json gatabestand voorgestelde\n',
                ...
                31: u'#    De zal de totale duur niet belangrijk beinvloeden, want dit wordt voornamelijk\n',
                ...
                74: u'# Test dit eerst vanaf de cosole want het versturen gebeurt na het sluiten van\n',
                ...
                95: u'# niet bestaat) en de logo bron en naam. Je kunt de naam naar behoefte aanpassen.\n',
                96: u'# Een ontbrekend ID betekent dat die bron deze zender niet levert.\n',
                97: u'# Het verwijderen van een ID schakelt de zender voor die bron uit, maar zorg dat\n',
                98: u'# de ";"s blijven staan! Je kunt echter beter de "disable_source" optie gebruiken.\n',
                99: u'# Zet de logo bron op 99 om zelf een volledige URL naar een logo te leveren.\n',
                100: u'#\n',
                101: u'# Om per zender opties in te stellen, kun je onderaan een sectie zoals: \n',
                102: u'# [Channel <channelID>]toevoegen, waarbij <channelID> het derde item is.\n',
                103: u'# Zie de WIKI op https://github.com/tvgrabbers/tvgrabnlpy/wiki voor verdere\n',
                104: u'# beschrijvingen. Je kunt de volgende opties instellen:\n',
                105: u'# Boolean waarden (True, 1, on of geen waarde betekent True. De rest False):\n',
            ...
            u'other':{
                ...
                5: u'De begintijd van deze verzamelactie: %s\n',
                6: u'Versie',
                7: u'Taal',
        ...
        u'fetch':{
            ...
            u'report':{
                ...
                12: u'\nDag %s voor zender %s bron %s wordt uit de cache gehaald.\n',
        ...
        u'merge':{
            ...
            u'stats':{
                ...
                10: u'%7.0f programma\'s in %s voor: %s - %s\n    (%2.0f groepslots),\n',
                11: u'%7.0f programma\'s in %s voor: %s - %s\n    (%2.0f groepslots)\n',
                12: u'%7.0f programma\'s gekoppeld op tijd en naam\n',
                13: u'%7.0f programma\'s nieuw toegevoegd\n',
                14: u'%7.0f programma\'s toegevoegd aan groepslots\n',
