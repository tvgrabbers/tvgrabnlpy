    ...
    texts = {
        u'config':{
            ...
            u'confighelp':{
                ...
                12: u'# and prime_source set in sourcematching.json if they are set different\n',
                ...
                93: u'# the group, the channelID, the ID\'s for the sources in the order as\n',
                94: u'# returned by the "--show-sources" option and finally the iconsource and name.\n',
                95: u'# You can change the names to suit your own preferences.\n',
                96: u'# A missing ID means the source doesn\'t supply the channel.\n',
                ...
                103: u'# See the WIKI at https://github.com/tvgrabbers/tvgrabnlpy/wiki for further descriptions\n',
                104: u'# You can use the following tags:\n',
        ...
        u'merge':{
            ...
            u'stats':{
                ...
                32: u'Kept unmatched:           %s: %s Genre: %s.\n',
                33: u'Leftover in %s:%s: %s Genre: %s.\n',
                34: u'Match from %s:%s: %s Genre: %s.\n',
                35: u'     on time and title to:%s: %s Genre: %s.\n',
                36: u'      from %s:%s: %s Genre: %s.\n',
