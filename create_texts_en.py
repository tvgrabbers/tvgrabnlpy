    ...
    texts = {
        u'config':{
            u'error':{
                ...
                -1: u'Error creating message text!\n',
                0: u'Text message not Found!\n',
        ...
        u'output':{
            u'error':{
                1: u'No Data from %s for channel: %s\n',
                2: u'Detail sources: %s died.\n',
                3: u'So we stop waiting for the pending details for channel %s\n',
                4: u'Detail statistics for %s (channel %s of %s)\n',
                5: u'%6.0f cache hit(s)\n',
                6: u'%6.0f without details in cache\n',
                7: u'%6.0f succesful ttvdb lookups\n',
                8: u'%6.0f    failed ttvdb lookups\n',
                9: u'%6.0f detail fetch(es) from %s.\n',
                10: u'%6.0f failure(s)\n',
                11: u'%6.0f without detail info\n',
                12: u'%6.0f left in the %s queue to process\n',
                13: u'Now Checking cache for %s programs on %s(xmltvid=%s%s)\n',
                14: u'    (channel %s of %s) for %s days.\n',
                15: u'Now fetching details for %s programs on %s(xmltvid=%s%s)\n',
                16: u'    [no fetch] %s:(%3.0f%%) %s\n',
                17: u'Splitting title "%s"\n'},
            u'other':{
                u'': u''}},
        u'sources':{
            u'error':{
                ...
                2: u'Now fetching %s channels from %s\n',
                3: u'    (day %s of %s).\n',
                4: u'No data on %s for day=%d\n',
                ...
                18: u'No data on %s for %s, week=%d!\n',
